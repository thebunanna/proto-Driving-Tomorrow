...
class App extends Component {
  ...
  render() {
    ...
    let tItem=<Panel key={x*_.max(boundY) + y} pos = {[x,y]} vis ={'visible'}/>;
...
class Panel extends Component {
  render (){
    ...
    switch (data[x][y].type) {
      case 'Gallery':
      f = <Gallery key = {y} src = {require('./gallery/'+data[x][y].src)} desc = {''}/>
    ...
    return (
    <div id = 'panel' style={{visibility:this.props.vis}}>
      {f}
